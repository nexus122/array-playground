...
let resultado = countries.filter( country => country.currencyName == "EURO"); // ✔️ TODO: Crea un nuevo array todos los paises que que usan el 'EURO' como mondeda
...
let pokemonsHada = pokemons.filter(pokemon => {
    let isFairy = false;
    ...
    return isFairy
}) // ✔️ TODO: Crea un nuevo array con todos los pokemons que son del tipo 'Fairy'
